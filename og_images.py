...
def make_image(feature_row, crs=4326):
    ...
    pio.write_image(fig, f"api/{feature_slug}.png", width=1200, height=630, scale=1)
...
if __name__ == "__main__":
    ...
    for filename in FILES:
        gf = gpd.read_file(f"src-geo/delimitations/{filename}.geojson")
