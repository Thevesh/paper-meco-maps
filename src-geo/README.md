...
- `peninsular_1959_dun`: There are 3 seats where there is inconsistency between the results data and the map in the same report. We choose the option which generates consistency with future names, to avoid requiring a separate map for 1964 purely due to renaming. Cases: We write Kangar Town as Bandar Kangar; Bandar Sri Penggaram as Bandar Penggaram; Kelawai as Kelawei. In all 3 cases, the name chosen is consistent with the election reports for 1964 and 1969.
